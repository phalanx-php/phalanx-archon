 ...
 * matching Signal value. restore() clears the registrations by passing
 * `null` through Process::signal(), which is the reactor's documented
...
final class SignalTrap
{
    ...
    /** @param Closure(Signal): void $onSignal */
    public static function install(SignalPolicy $policy, Closure $onSignal): self
    {
        $trap = new self();
