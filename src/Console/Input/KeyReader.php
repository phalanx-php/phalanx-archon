...
namespace Phalanx\Console\Console\Input;

use Phalanx\Scope\Disposable;
use Phalanx\Scope\Suspendable;

/**
 * Console-side abstraction over keypress reading. Production implementation
 * is RawInput (drains bytes from Runtime ConsoleInput through KeyParser).
