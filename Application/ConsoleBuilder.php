...
/**
 * Facade builder for Console console applications.
 *
...
final class ConsoleBuilder
{
    ...
    /** @var list<\Phalanx\Console\Console\ConsoleErrorRenderer> */
    ...
    public function withErrorRenderers(\Phalanx\Console\Console\ConsoleErrorRenderer ...$renderers): self
    {
